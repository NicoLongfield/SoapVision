...
def start_cameras():
    ...
    try:
        ...
        cv2.createTrackbar('X', 'Trackbars',0,1000,nothing)
        cv2.createTrackbar('Y', 'Trackbars',0,1000,nothing)
        cv2.createTrackbar('W', 'Trackbars',0,350,nothing)
        cv2.createTrackbar('H', 'Trackbars',0,350,nothing)
