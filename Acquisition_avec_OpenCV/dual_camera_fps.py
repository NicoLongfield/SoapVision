...
def start_cameras():
    ...
    try:
        ...
        cv2.createTrackbar('X', 'Trackbars',460,1000,nothing)
        cv2.createTrackbar('Y', 'Trackbars',300,1000,nothing)
        cv2.createTrackbar('W', 'Trackbars',220,350,nothing)
        cv2.createTrackbar('H', 'Trackbars',140,350,nothing)
